...
using SalesWebsite.Models.Enums;
using System;
...
namespace SalesWebsite.Data
{
    ...
    {
        private SalesWebsiteContext _context;

        public SeedingService(SalesWebsiteContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Department d3 = new Department(3, "Financial Analyst");
            Department d4 = new Department(4, "Comercial");
